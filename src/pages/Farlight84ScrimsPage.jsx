// src/pages/Farlight84ScrimsPage.jsx
    ...
    return (
        ...
        >
            <img
                ...
                alt="Farlight 84 Scrim Background"
...
export default function Farlight84ScrimsPage() {
        ...
        <div className="bg-dark-900 text-white min-h-screen">
            <div className="max-w-7xl mx-auto space-y-10 pb-10">
                <AnimatedSection delay={0} className="relative h-64 sm:h-80 w-full overflow-hidden shadow-xl">
                    <img src={GAME_BANNER_URL} alt="Farlight 84 Scrims Banner" className="absolute inset-0 w-full h-full object-cover object-center scale-105 opacity-80"/>
