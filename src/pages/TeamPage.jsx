// src/pages/TeamPage.jsx (UPDATED)
...
{/* 🗑️ Removed Join Team button */}
{/* 🔑 Converted Manage button to Link to new management page */}
<Link to="/manage-team" className="btn-secondary flex items-center">
