...
<old_str>export default function LeaguePage() {
  return (
    <div className="pt-20 min-h-screen bg-dark-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="card">
          <h1 className="text-3xl font-bold mb-6">League Standings</h1>
          <p className="text-gray-300">League table and standings will be displayed here.</p>
        </div>
      </div>
    </div>
  );
}</old_str>
<new_str>import { Trophy, TrendingUp, TrendingDown, Minus, Crown, Medal, Award } from 'lucide-react';
