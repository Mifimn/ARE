    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:w-2/3 space-y-10">
                <AnimatedSection delay={100} className="relative group overflow-hidden bg-gradient-to-br from-blue-700 via-indigo-800 to-blue-900 p-6 sm:p-8 rounded-2xl shadow-xl border-2 border-blue-500/50">
                     <div className="absolute inset-0 bg-[url('/images/lan_6.jpg')] bg-repeat opacity-[0.03] mix-blend-overlay"></div>
                     <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between"><h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-1 drop-shadow-lg">LAND OF DAWN</h2><p className="text-blue-200 text-base sm:text-lg mb-4 sm:mb-0">Featured Seasonal Championship Event</p><Link to="#" className="btn-primary bg-white text-blue-800 hover:bg-blue-100 font-bold py-3 px-6 rounded-xl flex items-center transition-colors text-base shadow-lg mt-4 sm:mt-0 transform hover:scale-105">GO TO EVENT <ArrowRight size={20} className="ml-2" /></Link></div>
                </AnimatedSection>
        ...
        <div className="bg-dark-900 text-white min-h-screen">
            <div className="max-w-full mx-auto space-y-10 pb-10">
                <AnimatedSection delay={0} className="relative h-64 sm:h-80 w-full overflow-hidden shadow-xl">
                    <img src={GAME_BANNER_URL} alt="Mobile Legends Banner" className="absolute inset-0 w-full h-full object-cover object-center scale-105 blur-sm opacity-40"/>
