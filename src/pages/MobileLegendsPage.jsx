// src/pages/MobileLegendsPage.jsx
...
// --- Placeholder Data & Components for Mobile Legends ---

const upcomingCups = [
    { id: 801, title: 'MLBB Africa Champions League - Qualifiers', format: '5v5 Draft Pick', entries: 64, date: '10 Nov', prize: '$2000+', image: 'https://images.unsplash.com/photo-1556438064-2d7646166914?w=300&h=200&fit=crop' },
    { id: 802, title: 'Land of Dawn Weekly Series - Nov Week 1', format: '5v5 Draft Pick', entries: 32, date: '12 Nov', prize: '$300', image: '/images/action_2.jpg' }, // Placeholder
];

const pastCups = [
    { id: 901, title: 'Mythic Glory Invitational - Season 4', format: '5v5 Draft Pick', entries: 16, date: '01 Oct', prize: '$5000', image: '/images/lan_7.jpg', winner: 'Savanna Kings'}, // Placeholder
    { id: 902, title: 'Rising Stars Cup - October', format: '5v5 Classic', entries: 48, date: '15 Sep', prize: '$500', image: '/images/lan_6.jpg', winner: 'Nile Knights'}, // Placeholder
];

const topTeams = [
    { rank: 1, name: 'Savanna Kings', points: 2100, members: 5, logo: '/images/team_s.png' }, // Placeholder logos
    { rank: 2, name: 'Nile Knights', points: 1950, members: 5, logo: '/images/team_c.png' },
    { rank: 3, name: 'Atlas Lions', points: 1800, members: 5, logo: '/images/team_l.png' },
    { rank: 4, name: 'Joburg Giants', points: 1720, members: 5, logo: '/images/team_z.png' },
];

const allTeams = [
    { name: 'Accra Assassins', members: 5, logo: '/images/team_a.png' },
    { name: 'Dakar Devils', members: 5, logo: '/images/team_d.png' },
    { name: 'Kinshasa Kings', members: 5, logo: '/images/team_o.png' },
];

// --- Placeholder Data for User's Joined MLBB Tournaments ---
const myJoinedMLBBTournaments = [
    { id: 801, title: 'MLBB Africa Champions League - Qualifiers', date: '10 Nov', status: 'Upcoming', nextMatch: 'vs Savanna Kings - 20:00' },
    // Add more joined MLBB tournaments here
];
// -----------------------------------------------------------
...
const CupListItem = ({ cup, isPast = false }) => (
    <Link
        to={`/tournament/${cup.id}`} // Link to dynamic tournament route
    ...
    >
        <img
            src={cup.image || '/images/ml_cup_thumb.jpg'} // Placeholder thumbnail
            alt="Cup Background"
...
// --- Content Components (Adapted for Mobile Legends) ---
...
const CupsContent = () => (
    <AnimatedSection delay={0} className="space-y-10">
        <h2 className="text-3xl font-bold text-primary-400 border-b-2 border-primary-500/30 pb-3 flex items-center">
            <Trophy size={28} className="mr-3" /> Mobile Legends Cups
        </h2>
        <p className="text-gray-300 text-lg">Upcoming official cups and tournament history for Mobile Legends: Bang Bang.</p>
        {/* Upcoming */}
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {upcomingCups.length === 0 && <p className="text-gray-500 md:col-span-2">No upcoming MLBB cups scheduled.</p>}
            </div>
        </div>
        {/* Past */}
...
const LeaderboardContent = () => (
    <AnimatedSection delay={0} className="space-y-8">
        <h2 className="text-3xl font-bold text-primary-400 border-b-2 border-primary-500/30 pb-3 flex items-center">
            <BarChart size={28} className="mr-3" /> Mobile Legends Leaderboard
        </h2>
        <p className="text-gray-300 text-lg">Top MLBB teams on the Africa Rise Esports circuit.</p>
...
const TeamsContent = () => (
    <AnimatedSection delay={0} className="space-y-8">
        <h2 className="text-3xl font-bold text-primary-400 border-b-2 border-primary-500/30 pb-3 flex items-center"><Users size={28} className="mr-3" /> MLBB Team Directory</h2>
        <p className="text-gray-300 text-lg">Find Mobile Legends teams or create your own squad.</p>
        <AnimatedSection delay={100} className="bg-gradient-to-r from-green-600/30 to-dark-800/50 p-6 rounded-xl border border-green-500/50 shadow-lg flex items-center justify-between">
            <div><h3 className="text-2xl font-bold text-white mb-2">Assemble Your Heroes</h3><p className="text-green-200">Create your MLBB team and conquer the Land of Dawn.</p></div>
...
export default function MobileLegendsPage() {
    ...
    // Placeholder Rundown data for MLBB
    const recentMatchesRundown = [
        { winner: 'MythicMaster', loser: 'EpicWarrior', winnerScore: 2, loserScore: 1, winnerLogo: '/images/ava_m_8.png', loserLogo: '/images/ava_m_9.png' }, // Example player match
        { teams: ['/images/team_s.png', '/images/team_c.png', '/images/team_l.png', '/images/team_z.png', '/images/team_a.png'] }, // Example team logos
        { teams: ['/images/team_d.png', '/images/team_r.png', '/images/team_o.png', '/images/team_x.png', '/images/team_y.png'] },
    ];
            ...
            case 'rundown': default: return (
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="lg:w-2/3 space-y-10">
                        <AnimatedSection delay={100} className="relative group overflow-hidden bg-gradient-to-br from-indigo-700 via-purple-800 to-indigo-900 p-6 sm:p-8 rounded-2xl shadow-xl border-2 border-purple-500/50">
                             <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1556438064-2d7646166914?w=1000&h=600&fit=crop')] bg-cover opacity-[0.07] mix-blend-luminosity"></div>
                             <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between"><h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-1 drop-shadow-lg">ARE CHAMPIONS LEAGUE</h2><p className="text-purple-200 text-base sm:text-lg mb-4 sm:mb-0">The Pinnacle of African MLBB Competition</p><Link to="/event/acl-mlbb" className="btn-primary bg-white text-purple-800 hover:bg-purple-100 font-bold py-3 px-6 rounded-xl flex items-center transition-colors text-base shadow-lg mt-4 sm:mt-0 transform hover:scale-105">LEAGUE DETAILS <ArrowRight size={20} className="ml-2" /></Link></div>
                        </AnimatedSection>
                    ...
                    <div className="lg:w-1/3 space-y-10">
                        ...
                        <AnimatedSection delay={300} className="card bg-dark-800 p-6 rounded-xl shadow-lg border border-dark-700">
                             ...
                             {myJoinedMLBBTournaments.length > 0 ? (
                                <div className="space-y-4">
                                    {myJoinedMLBBTournaments.map((tournament, index) => (
        ...
        <div className="bg-dark-900 text-white min-h-screen">
            <div className="max-w-full mx-auto space-y-10 pb-10">
                <AnimatedSection delay={0} className="relative h-64 sm:h-80 w-full overflow-hidden shadow-xl">
                    <img src="https://images.unsplash.com/photo-1556438064-2d7646166914?w=1200&h=400&fit=crop" alt="Mobile Legends Banner" className="absolute inset-0 w-full h-full object-cover object-center scale-105 blur-sm opacity-40"/>
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-end max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12">
                         <div className="flex items-center mb-4"><Gamepad2 className="w-10 h-10 sm:w-12 sm:h-12 mr-4 text-purple-400 bg-dark-800/50 p-2 rounded-lg border border-purple-500/30" /><h1 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-md">MOBILE LEGENDS HUB</h1></div>
                         <p className="text-lg sm:text-xl text-gray-300 max-w-3xl">Dive into the Mobile Legends arena. Find tournaments, teams, and rankings.</p>
                    </div>
                </AnimatedSection>
